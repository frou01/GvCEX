...
public class GVCEntityC4 extends Entity implements IProjectile
{
    ...
    public GVCEntityC4(World p_i1753_1_)
    {
        super(p_i1753_1_);
    ...
    public GVCEntityC4(World p_i1754_1_, double p_i1754_2_, double p_i1754_4_, double p_i1754_6_)
    {
        super(p_i1754_1_);
        this.renderDistanceWeight = 10.0D;
        this.setSize(0.5F, 0.5F);
    ...
    public GVCEntityC4(World p_i1755_1_, EntityLivingBase p_i1755_2_, EntityLivingBase p_i1755_3_, float p_i1755_4_, float p_i1755_5_)
    {
        super(p_i1755_1_);
        this.renderDistanceWeight = 10.0D;
    ...
    public GVCEntityC4(World p_i1756_1_, EntityLivingBase p_i1756_2_, float p_i1756_3_)
    {
        super(p_i1756_1_);
        this.renderDistanceWeight = 10.0D;
    ...
    public void explode()
    {
        ...
        //this.worldObj.newExplosion(this, this.posX, this.posY, this.posZ, 3.5, Flame, Blockbreak);
    ...
    public void onCollideWithPlayer(EntityPlayer p_70100_1_)
    {
        if (!this.worldObj.isRemote && this.inGround && this.arrowShake <= 0)
        {
            ...
            if (this.canBePickedUp == 1 && !p_70100_1_.inventory.addItemStackToInventory(new ItemStack(GVCUtils.fn_c4, 1)))
            {
                flag = false;
            }
