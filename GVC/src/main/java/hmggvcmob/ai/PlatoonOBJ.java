...
public class PlatoonOBJ implements IUpdatePlayerListBox {
	...
	private void SetPlatoonFormationUpdate(){
	...
	public void sortMember(EntityAndPos entityAndPos){
		...
		if(!entity.isDead && canMoveEntity(entity) && entityAndPos.entity.ridingEntity instanceof EntityDummy_rider){
