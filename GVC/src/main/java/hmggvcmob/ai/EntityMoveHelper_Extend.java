...
public class EntityMoveHelper_Extend extends EntityMoveHelper
{
    ...
    public EntityMoveHelper_Extend(EntityLiving p_i1614_1_)
    {
        super(p_i1614_1_);
    ...
    public void onUpdateMoveHelper()
    {
        ...
        if (this.update)
        {
            ...
            if (d3 >= 2.500000277905201E-7D)
            {
                ...
                this.entity.rotationYaw = this.limitAngle(this.entity.rotationYaw, (speed<0 ? -f:f), 90.0F);
