...
public class AIMoveThroughVillage extends EntityAIBase
{
    ...
    public AIMoveThroughVillage(EntityCreature p_i1638_1_, double p_i1638_2_, boolean p_i1638_4_)
    {
        ...
        else
        {
            ...
            else
            {
                ...
                else
                {
                    ...
                    theEntity.getEntityAttribute(SharedMonsterAttributes.followRange).setBaseValue(30.0D);
                    ...
                    theEntity.getEntityAttribute(SharedMonsterAttributes.followRange).setBaseValue(60.0D);
