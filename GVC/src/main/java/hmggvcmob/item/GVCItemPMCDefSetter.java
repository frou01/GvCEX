        ...
        if(!world.isRemote) {
            if (entityPlayer.isSneaking()) {
                ...
                if(mode == 1){
                    ...
                    MovingObjectPosition movingobjectposition = handmadeguns.Util.Utils.getmovingobjectPosition_forBlock(world,vec3, vec31, false, true, false);//è’ìÀÇ∑ÇÈÉuÉçÉbÉNÇí≤Ç◊ÇÈ
