...
public class PathPoint_slow extends PathPoint{
    ...
    PathPoint_slow previous;
    /** Indicates this is the origin */
    public boolean isFirst;
    private static final String __OBFID = "CL_00000574";

    public PathPoint_slow(int p_i2135_1_, int p_i2135_2_, int p_i2135_3_)
    {
    ...
    public boolean equals(Object p_equals_1_)
    {
        ...
        {
            PathPoint_slow pathpoint = (PathPoint_slow)p_equals_1_;
