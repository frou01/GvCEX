package hmggvcmob.SlowPathFinder;
...
public class ChunkChaceForPathfind implements IBlockAccess
{
    private int chunkX;
    private int chunkZ;
    ...
    private WorldForPathfind worldObj;
    private static final String __OBFID = "CL_00000155";

    public ChunkChaceForPathfind(WorldForPathfind p_i1964_1_, int p_i1964_2_, int p_i1964_3_, int p_i1964_4_, int p_i1964_5_, int p_i1964_6_, int p_i1964_7_, int p_i1964_8_)
    {
        ...
        for (j2 = this.chunkX; j2 <= l1; ++j2)
        {
            ...
            {
                chunk = p_i1964_1_.world.getChunkFromChunkCoords(j2, k2);
    ...
    {
        return this.worldObj.world.getBiomeGenForCoords(p_72807_1_, p_72807_2_);
    }
    ...
    public int getSkyBlockTypeBrightness(EnumSkyBlock p_72810_1_, int p_72810_2_, int p_72810_3_, int p_72810_4_)
    {
        ...
        {
            if (p_72810_1_ == EnumSkyBlock.Sky && this.worldObj.world.provider.hasNoSky)
            {
                return 0;
            }
            else
