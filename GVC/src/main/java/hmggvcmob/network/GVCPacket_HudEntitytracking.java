...
public class GVCPacket_HudEntitytracking implements IMessage {
    public float[][] trackedEntityPos;
    public int TGTEntityID;

    public GVCPacket_HudEntitytracking(){
    }
    public GVCPacket_HudEntitytracking(Entity pilot,ArrayList<Entity> entitys){
