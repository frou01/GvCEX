...
public class GVCPakcetVehicleTurretSync implements IMessage {
    public int targetID;
    ...
    public GVCPakcetVehicleTurretSync(){
    }
    public GVCPakcetVehicleTurretSync(int tgtid , IMultiTurretVehicle multiTurretVehicle){
        targetID = tgtid;
