...
public abstract class MobSpawnerBaseLogic_Extend 
{
    /** The delay to spawn. */
    public int spawnDelay = 20;
    private String entityTypeName = "GVCMob.GVC_Spawner_Throw";
    ...
    private int minSpawnDelay = 1200;
    private int maxSpawnDelay = 2400;
    /** A counter for spawn tries. */
    private int spawnCount = 1;
    private Entity field_98291_j;
    private int maxNearbyEntities = 4;
    /** The distance from which a player activates the spawner. */
    private int activatingRangeFromPlayerMax = 128;
    private int activatingRangeFromPlayerMin = 256;
    ...
    {
        Entity cloasestPlayer = this.getSpawnerWorld().getClosestPlayer((double)this.getSpawnerX() + 0.5D, (double)this.getSpawnerY() + 0.5D, (double)this.getSpawnerZ() + 0.5D, (double)this.activatingRangeFromPlayerMax);

        return  cloasestPlayer != null && cloasestPlayer.getDistanceSq(getSpawnerX(),getSpawnerY(),getSpawnerZ())>activatingRangeFromPlayerMin;
    }
    ...
    private void resetTimer()
    {
        ...
        {
            this.setRandomEntity((WeightedRandomMinecart) WeightedRandom.getRandomItem(this.getSpawnerWorld().rand, this.potentialEntitySpawns));
        }
    ...
    public void readFromNBT(NBTTagCompound p_98270_1_)
    {
        ...
        if (p_98270_1_.hasKey("SpawnPotentials", 9))
        {
            ...
            {
                this.potentialEntitySpawns.add(new WeightedRandomMinecart(nbttaglist.getCompoundTagAt(i)));
            }
        }
        else
        {
        ...
        {
            this.setRandomEntity(new WeightedRandomMinecart(p_98270_1_.getCompoundTag("SpawnData"), this.entityTypeName));
        }
        else
        {
        ...
        if (p_98270_1_.hasKey("MaxNearbyEntities", 99))
        {
            ...
            this.activatingRangeFromPlayerMax = p_98270_1_.getShort("RequiredPlayerRange");
        }
    ...
    public void writeToNBT(NBTTagCompound p_98280_1_)
    {
        ...
        p_98280_1_.setShort("RequiredPlayerRange", (short)this.activatingRangeFromPlayerMax);
