...
public class ModifiedBoundingBox extends AxisAlignedBB {
    ...
    public static ModifiedBoundingBox getBoundingBox(double p_72330_0_, double p_72330_2_, double p_72330_4_, double p_72330_6_, double p_72330_8_, double p_72330_10_,double rmX,double rmY,double rmZ,Quat4d rot,double posX,double posY, double posZ,double centerRotX,double centerRotY, double centerRotZ,double centerOffsetX,double centerOffsetY, double centerOffsetZ)
    {
        ...
        newbox.posY = posY;
        newbox.posZ = posZ;
        newbox.centerRotX = centerRotX;
        newbox.centerRotY = centerRotY;
        newbox.centerRotZ = centerRotZ;
        newbox.centerOffsetX = centerOffsetX;
        newbox.centerOffsetY = centerOffsetY;
        newbox.centerOffsetZ = centerOffsetZ;
        newbox.rot = rot;
        return newbox;
    }
    ...
    public AxisAlignedBB addCoord(double p_72321_1_, double p_72321_3_, double p_72321_5_)
    {
        ...
        return getBoundingBox(d3, d4, d5, d6, d7, d8,
                realmaxX,
                realmaxY,
                realmaxZ,rot,posX,posY,posZ,centerRotX,centerRotY,centerRotZ,centerOffsetX,centerOffsetY,centerOffsetZ);
    }
...
//        System.out.println("debug max x " + (maxZ));
        return
                hittingbox.maxX > minX && hittingbox.minX < maxX &&
                hittingbox.maxY > minY && hittingbox.minY < maxY &&
                hittingbox.maxZ > minZ && hittingbox.minZ < maxZ;
    }
