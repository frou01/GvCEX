...
public class GVCEntityChild extends Entity implements IEntityAdditionalSpawnData,EntityHasMaster {
    public Entity master;
    public boolean rideable;
    public int idinmasterEntityt = -1;
    public float thirddist = 4;
    public GVCEntityChild(World p_i1582_1_) {
        super(p_i1582_1_);
        this.setSize(1,2);
        rideable = true;
    }
    ...
    public GVCEntityChild(World p_i1582_1_, float x, float y, boolean rideable) {
        super(p_i1582_1_);
        this.setSize(x,y);
...
//    }
    ...
    public void readSpawnData(ByteBuf additionalData) {
        ...
        if(master instanceof ImultiRideableVehicle){
            ((ImultiRideableVehicle) master).addChild(this);
        }
    }
