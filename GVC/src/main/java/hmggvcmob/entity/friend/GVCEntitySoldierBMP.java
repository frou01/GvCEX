...
//	public float subturretrotationPitch;
	...
	public TankBaseLogic baseLogic = new TankBaseLogic(this,0.2f,1.5f,false,"gvcmob:gvcmob.BMPTrack");
	...
	public GVCEntitySoldierBMP(World par1World)
	{
		super(par1World);
...
//        }
	...
	public void subFire(){
		...
		if(rand.nextInt(9) == 0) {
			...
			transformVecforMinecraft(temp);
//			System.out.println(temp);
			GVCXEntitySoldierSpawn var30 = new GVCXEntitySoldierSpawn(this.worldObj);
			var30.motionX = (rand.nextInt(100) - 50) / 50;
			var30.motionY = 1;
			var30.motionZ = (rand.nextInt(100) - 50) / 50;
