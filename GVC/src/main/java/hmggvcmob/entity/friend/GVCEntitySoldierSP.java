...
public class GVCEntitySoldierSP extends EntitySoBase
{
    public GVCEntitySoldierSP(World par1World)
    {
        super(par1World);
        this.setSize(0.6F, 1.8F);
        this.tasks.addTask(1,aiAttackGun = new AIAttackGun(this,120,20,10,30,true,true,new WorldForPathfind(worldObj)));
    }
    ...
    public void addRandomArmor()
    {
        ...
        this.setCurrentItemOrArmor(0, new ItemStack(GVCUtils.fn_m110));
    }
...
//			}
//			//gun.flash = false;
//			if (cooltime > 40 + this.worldObj.rand.nextInt(5)) {// 2
//				if ((x < 50 && z < 50))
//				{
//					boolean flag = this.getEntitySenses().canSee(entity1);
