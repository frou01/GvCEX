...
public class GVCEntitySoldierMG extends EntitySoBase
{
    public GVCEntitySoldierMG(World par1World)
    {
        super(par1World);
        this.setSize(0.6F, 1.8F);
        this.tasks.addTask(1,aiAttackGun = new AIAttackGun(this,120,20,40,10,true,true,new WorldForPathfind(worldObj)));
    }
    ...
    public void addRandomArmor()
    {
        ...
        this.setCurrentItemOrArmor(0, new ItemStack(GVCUtils.fn_m240b));
    }
