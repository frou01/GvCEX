...
public class GVCEntityGuerrillaM extends EntityMob
{
    ...
    */
    ...
    private void createEnderPortal(int par1, int par2, int par3)
    {
        ...
        this.worldObj.setBlock(par1+3, par2+0, par3-2, Blocks.wool,13,2);
        this.worldObj.setBlock(par1+3, par2+0, par3-1, Blocks.wool,13,2);
        this.worldObj.setBlock(par1+3, par2+0, par3+1, Blocks.wool,13,2);
        this.worldObj.setBlock(par1+3, par2+0, par3+2, Blocks.wool,13,2);
        this.worldObj.setBlock(par1+3, par2+0, par3+3, Blocks.fence);
        ...
        this.worldObj.setBlock(par1-1, par2+0, par3-3, Blocks.wool,13,2);
        this.worldObj.setBlock(par1-2, par2+0, par3-3, Blocks.wool,13,2);
        this.worldObj.setBlock(par1+1, par2+0, par3-3, Blocks.wool,13,2);
        this.worldObj.setBlock(par1+2, par2+0, par3-3, Blocks.wool,13,2);
        ...
        this.worldObj.setBlock(par1+3, par2+1, par3-2, Blocks.wool,13,2);
        this.worldObj.setBlock(par1+3, par2+1, par3-1, Blocks.wool,13,2);
        this.worldObj.setBlock(par1+3, par2+1, par3+1, Blocks.wool,13,2);
        this.worldObj.setBlock(par1+3, par2+1, par3+2, Blocks.wool,13,2);
        this.worldObj.setBlock(par1+3, par2+1, par3+3, Blocks.fence);
        ...
        this.worldObj.setBlock(par1-1, par2+1, par3-3, Blocks.wool,13,2);
        this.worldObj.setBlock(par1-2, par2+1, par3-3, Blocks.wool,13,2);
        this.worldObj.setBlock(par1+1, par2+1, par3-3, Blocks.wool,13,2);
        this.worldObj.setBlock(par1+2, par2+1, par3-3, Blocks.wool,13,2);
