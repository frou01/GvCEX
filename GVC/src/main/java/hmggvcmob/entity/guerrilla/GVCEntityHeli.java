...
//		((ModifiedBoundingBox)this.boundingBox).update(this.posX,this.posY,this.posZ);
		...
		baseLogic.prefab_vehicle.yawspeed = 0.02f;
		baseLogic.prefab_vehicle.liftfactor = 0;
		...
		baseLogic.prefab_vehicle.maxDive = 5;
		baseLogic.prefab_vehicle.minALT = 5;
		baseLogic.prefab_vehicle.cruiseALT = 20;
