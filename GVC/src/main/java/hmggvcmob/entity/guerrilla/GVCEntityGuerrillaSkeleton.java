...
import static hmggvcmob.GVCMobPlus.Guns_BoltR;
import static hmggvcmob.GVCMobPlus.cfg_guerrillasrach;

public class GVCEntityGuerrillaSkeleton extends EntityGBase
{
    public GVCEntityGuerrillaSkeleton(World par1World)
    {
        super(par1World);
...
//        this.tasks.removeTask(new EntityAIOpenDoor(this, true));
    ...
    public void addRandomArmor()
    {
        ...
        this.setCurrentItemOrArmor(0, new ItemStack((Item)Guns_BoltR.get(rnd.nextInt(Guns_BoltR.size()))));
    }
