...
public class GVCEntityGuerrillaMG extends EntityGBase
{
    public GVCEntityGuerrillaMG(World par1World)
    {
        super(par1World);
    ...
    public void addRandomArmor()
    {
        ...
        this.setCurrentItemOrArmor(0, new ItemStack((Item)Guns_LMG.get(rnd.nextInt(Guns_LMG.size()))));
    }
