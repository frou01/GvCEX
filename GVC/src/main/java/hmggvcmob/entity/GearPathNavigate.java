...
//    private boolean canPassOpenWoodenDoors = true;
    ...
    public GearPathNavigate(Entity p_i1671_1_, World p_i1671_2_)
    {
    ...
    public void onUpdateNavigation()
    {
        ...
        if (!this.noPath())
        {
            ...
            if (!this.noPath())
            {
                ...
                if (vec3 != null)
                {
//                    this.theEntity.getMoveHelper().setMoveTo(vec3.xCoord, vec3.yCoord, vec3.zCoord, this.speed);‚Â‚Á‚©‚¦
                }
            }
        }
    }
