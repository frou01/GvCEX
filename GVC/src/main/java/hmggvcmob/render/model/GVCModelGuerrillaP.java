...
public class GVCModelGuerrillaP extends ModelBiped
{
    ...
    public GVCModelGuerrillaP()
    {
        this(0.0F, false);
    }

    protected GVCModelGuerrillaP(float par1, float par2, int par3, int par4)
    {
	...
	public GVCModelGuerrillaP(float par1, boolean par2)
    {
