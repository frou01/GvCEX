...
import hmggvcmob.entity.friend.GVCEntitySoldierTank;
...
public class GVCRenderSoldierTankobj extends Render {

	private static final ResourceLocation skeletonTexturesz = new ResourceLocation("gvcmob:textures/mob/kai/MBT-70.png");
	private static final IModelCustom bodyobj = AdvancedModelLoader.loadModel(new ResourceLocation("gvcmob:textures/mob/kai/MBT-70-body.obj"));
	private static final IModelCustom turretobj = AdvancedModelLoader.loadModel(new ResourceLocation("gvcmob:textures/mob/kai/MBT-70-turret.obj"));
	private static final IModelCustom catobj = AdvancedModelLoader.loadModel(new ResourceLocation("gvcmob:textures/mob/kai/MBT-70-cat.obj"));
	private float scale;

	public GVCRenderSoldierTankobj() {
		this.scale = 2;
	}

	public void doRender(Entity p_76986_1_, double p_76986_2_, double p_76986_4_, double p_76986_6_, float p_76986_8_,
			float p_76986_9_) {
		this.doRender((GVCEntitySoldierTank) p_76986_1_, p_76986_2_, p_76986_4_, p_76986_6_, p_76986_8_, p_76986_9_);
	}
	...
	*/
	...
	float xsxs;
	public void doRender(GVCEntitySoldierTank entity, double p_76986_2_, double p_76986_4_, double p_76986_6_,
