...
import hmggvcmob.entity.friend.GVCEntityFriendGK;
...
public class GVCRenderFriendGK extends Render {

	private static final ResourceLocation skeletonTexturesz = new ResourceLocation("gvcmob:textures/mob/kai/fgekkou.png");
	private static final IModelCustom tankk = AdvancedModelLoader.loadModel(new ResourceLocation("gvcmob:textures/mob/kai/gekkou.obj"));
	private float scale;

	public GVCRenderFriendGK() {
		this.scale = 2;
	}

	public void doRender(Entity p_76986_1_, double p_76986_2_, double p_76986_4_, double p_76986_6_, float p_76986_8_,
			float p_76986_9_) {
		this.doRender((GVCEntityFriendGK) p_76986_1_, p_76986_2_, p_76986_4_, p_76986_6_, p_76986_8_, p_76986_9_);
	}
	
	float xsxs;
	public void doRender(GVCEntityFriendGK entity, double p_76986_2_, double p_76986_4_, double p_76986_6_,
...
//			GL11.glRotatef(-30, 0.0f, 0.0F, 1.0F);
	...
	private void renderlegs(GVCEntityFriendGK p_76986_1_){
