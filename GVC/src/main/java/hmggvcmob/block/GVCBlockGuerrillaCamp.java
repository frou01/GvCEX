...
public class GVCBlockGuerrillaCamp extends Block
{
    ...
    public void onBlockAdded(World par1World, int par1, int par2, int par3)
    {
    	...
    	par1World.setBlock(par1+12, par2+7, par3+12, Blocks.mob_spawner, 2, 2);
        TileEntityMobSpawner tileentitymobspawner = (TileEntityMobSpawner)par1World.getTileEntity(par1+12, par2+7, par3+12);

        if (tileentitymobspawner != null)
        {
            tileentitymobspawner.func_145881_a().setEntityName("GVCMob.Guerrilla");
        }
        ...
        par1World.setBlock(par1+10, par2+0, par3+4, Blocks.mob_spawner, 2, 2);
        par1World.setBlock(par1+12, par2+0, par3+10, Blocks.mob_spawner, 2, 2);
        TileEntityMobSpawner tileentitymobspawner5 = (TileEntityMobSpawner)par1World.getTileEntity(par1+10, par2+0, par3+4);
        if (tileentitymobspawner5 != null)
        {tileentitymobspawner5.func_145881_a().setEntityName("GVCMob.Guerrilla");
        }
        TileEntityMobSpawner tileentitymobspawner6 = (TileEntityMobSpawner)par1World.getTileEntity(par1+12, par2+0, par3+10);
        if (tileentitymobspawner6 != null)
        {tileentitymobspawner6.func_145881_a().setEntityName("GVCMob.Guerrilla");
        }
