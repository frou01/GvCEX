...
public class GVCBlockGuerrillaCamp2 extends Block
{
    ...
    public void onBlockAdded(World par1World, int par1, int par2, int par3)
    {
    	...
    	for (int x = 0; x < 4; ++x){
    		...
    		par1World.setBlock(par1+6+x, par2+4, par3+0, Blocks.wool,13,2);
    		par1World.setBlock(par1+6+x, par2+4, par3+15, Blocks.wool,13,2);
    	...
    	for (int x = 0; x < 8; ++x){
    		...
    		par1World.setBlock(par1+4+x, par2+4, par3+1, Blocks.wool,13,2);
    		par1World.setBlock(par1+4+x, par2+4, par3+14, Blocks.wool,13,2);
    	...
    	for (int x = 0; x < 10; ++x){
    		...
    		par1World.setBlock(par1+3+x, par2+4, par3+2, Blocks.wool,13,2);
    		par1World.setBlock(par1+3+x, par2+4, par3+13, Blocks.wool,13,2);
    	...
    	for (int x = 0; x < 12; ++x){
    		...
    		par1World.setBlock(par1+2+x, par2+4, par3+3, Blocks.wool,13,2);
    		par1World.setBlock(par1+2+x, par2+4, par3+12, Blocks.wool,13,2);
    	...
    	for (int x = 0; x < 14; ++x){
    		...
    		par1World.setBlock(par1+1+x, par2+4, par3+4, Blocks.wool,13,2);
    		par1World.setBlock(par1+1+x, par2+4, par3+11, Blocks.wool,13,2);
    		par1World.setBlock(par1+1+x, par2+4, par3+5, Blocks.wool,13,2);
    		par1World.setBlock(par1+1+x, par2+4, par3+10, Blocks.wool,13,2);
    	...
    	for (int x = 0; x < 16; ++x){
    		...
    		par1World.setBlock(par1+0+x, par2+4, par3+6, Blocks.wool,13,2);
    		par1World.setBlock(par1+0+x, par2+4, par3+7, Blocks.wool,13,2);
    		par1World.setBlock(par1+0+x, par2+4, par3+8, Blocks.wool,13,2);
    		par1World.setBlock(par1+0+x, par2+4, par3+9, Blocks.wool,13,2);
