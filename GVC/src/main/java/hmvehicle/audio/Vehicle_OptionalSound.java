...
public class Vehicle_OptionalSound extends MovingSound
{
	...
	public Vehicle_OptionalSound(String soundname , Entity p_i45105_1_,HasLoopSound hasLoopSound, float maxdist,int time)
	{
