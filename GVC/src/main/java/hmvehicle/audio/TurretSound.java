...
public class TurretSound extends MovingSound
{
	...
	public void update()
	{
		if (attachedturret.currentEntity ==null || this.attachedturret.currentEntity.isDead)
		{
		...
		else
		{
			...
			disttoPlayer = attachedturret.currentEntity.getDistanceSqToEntity(proxy.getMCInstance().renderViewEntity);
