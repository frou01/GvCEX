...
public class EntityUSA_FighterA extends EntityUSABase
{
	// public int type;
				...
				if (this.server1) {
					if (cooltime > this.ammo1 && this.getRemain_L() > 0) {
							this.Weapon(1, player, 1.57F, 2, 1.1, 1.0,this.posX,this.posY,this.posZ,
									...
									8, 4F, 1F, 1, 1, 0.025D, false);//1.57/1.5/3
							this.Weapon(1, player, -1.57F, 2, 1.1, 1.0,this.posX,this.posY,this.posZ,
									"gvclib:textures/entity/BulletAAA.obj","gvclib:textures/entity/BulletAAA.png","hmgww2:hmgww2.fire_rifle", look,
									8, 4F, 1F, 1, 1, 0.025D, false);//1.57/1.5/3
						cooltime = 0;
			...
			if(cooltime2 > this.ammo2 && this.getRemain_R() > 0)
			{
				if(this.getWeaponMode() == 1)
				{
					this.Attacktask(11, 2, 30D, "gvclib:textures/entity/BulletAAA.obj",
							"gvclib:textures/entity/BulletAAA.png", "hmgww2:hmgww2.fire", 0, 0, -1, 1.0,
							this.posX, this.posY, this.posZ, 30, 40,
						     400, 2F, 1F, 4F, 1, 0.029D, 1200, 0, false);
				}else{
