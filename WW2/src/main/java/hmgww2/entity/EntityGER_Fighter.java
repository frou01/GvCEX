...
public class EntityGER_Fighter extends EntityGERBase
{
	// public int type;
    ...
    public void onUpdate()
    {
		...
		//AI_AirCraftSet.setfighter(this, "hmgww2:hmgww2.sound_pera", f1, sp, 0.1F);
		this.AirCraftSet();
    	...
    	{// 1
			...
			//AI_EntityMoveAirCraft.movefighter(this, this, f1, sp, turnspeed, 40, 100);
