...
public class AITankBombEnemyFlag extends EntityAIBase {
	...
	public void updateTask() {
		...
		if(tank_SPdata.getMainTurret() != null && ((TankBaseLogic)tank_SPdata.getBaseLogic()).aimMainTurret_toPos(tank_SPdata.getTargetpos()[0],tank_SPdata.getTargetpos()[1],tank_SPdata.getTargetpos()[2])){
