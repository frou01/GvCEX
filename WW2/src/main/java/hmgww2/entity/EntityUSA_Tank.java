...
public class EntityUSA_Tank extends EntityUSABase
{
	// public int type;
	...
	public boolean attackEntityFrom(DamageSource source, float par2)
    {
		...
		if(entity != null){
			...
			{
				par2 = par2 * this.TankArmor(entity,par2, 0.5F, 1.0F, 1.0F, this.rotation) * this.AntiBullet(entity, par2,2);
			...
			// attacktask
			{
				if(cooltime > ammo1 && this.getRemain_L() > 0)
				{
					this.Attacktask(3, 1, 40D, "gvclib:textures/entity/BulletAAA.obj",
							"gvclib:textures/entity/BulletAAA.png", "hmgww2:hmgww2.fire_amr", 0, 0, 2.7, 1.8,
							this.posX, this.posY, this.posZ, 15, 5,
							50, 1.6F, 1F, 3F, 1, 0.025D, 400, 0, true);
				}
			}
		} // 1
