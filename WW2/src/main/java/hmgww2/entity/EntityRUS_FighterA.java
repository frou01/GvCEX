...
public class EntityRUS_FighterA extends EntityRUSBase
{
	// public int type;
	
    public EntityRUS_FighterA(World par1World)
    {
        super(par1World);
        this.setSize(4F, 2F);
	...
	public boolean attackEntityFrom(DamageSource source, float par2)
    {
		...
		if(entity != null){
	        ...
	        {
				par2 = par2 * this.AntiBulletAir(entity, par2,1);
    ...
    public void onUpdate()
    {
		...
		this.magazine = 40;
		reload_time1 = 200;
		this.w1name = "23mmMachineCannon & 7.62mmMachineGun";
			...
			if (this.riddenByEntity instanceof EntityPlayer) {
				...
				if (this.server1) {
					if (cooltime > this.ammo1 && this.getRemain_L() > 0) {
							...
							this.Weapon(1, player, -1.57F, 2, 1.1, 1.0,this.posX,this.posY,this.posZ,
									"gvclib:textures/entity/BulletAAA.obj","gvclib:textures/entity/BulletAAA.png","hmgww2:hmgww2.fire_30mm", look,
									12, 3F, 1F, 1, 1, 0.025D, false);//1.57/1.5/3
							this.Weapon(0, player, 1.57F, 2.3, 1.1, 1.0,this.posX,this.posY,this.posZ,
				...
				if (this.server2) {
					if (cooltime2 > this.ammo2 && this.getRemain_R() > 0) {
						if(this.getWeaponMode() == 1)
						{
							this.Weapon(3, player, 1.57F, 2, 1.1, 1.0,this.posX,this.posY,this.posZ,
									"gvclib:textures/entity/BulletAAA.obj","gvclib:textures/entity/BulletAAA.png","hmgww2:hmgww2.fire_amr", look,
									30, 4F, 1F, 2, 1, 0.025D, true);//1.57/1.5/3
							this.Weapon(3, player, -1.57F, 2, 1.1, 1.0,this.posX,this.posY,this.posZ,
									"gvclib:textures/entity/BulletAAA.obj","gvclib:textures/entity/BulletAAA.png","hmgww2:hmgww2.fire_amr", look,
									30, 4F, 1F, 2, 1, 0.025D, true);//1.57/1.5/3
						}else{
    	...
    	{// 1
			...
			{
				this.Attacktask(0, 15, 40D, "gvclib:textures/entity/BulletAAA.obj",
						"gvclib:textures/entity/BulletAAA.png", "hmgww2:hmgww2.fire_rifle", 1.57F, 2.3, 1.1, 1.0,
			...
			if(cooltime2 > this.ammo2 && this.getRemain_R() > 0)
			{
				if(this.getWeaponMode() == 1)
				{
					this.Attacktask(3, 15, 40D, "gvclib:textures/entity/BulletAAA.obj",
							"gvclib:textures/entity/BulletAAA.png", "hmgww2:hmgww2.fire_amr", 1.57F, 2, 1.1, 1.0,
							this.posX, this.posY, this.posZ, 15, 15,
							30, 4F, 1F, 1F, 1, 0.020D, 400, 0, true);
					this.Attacktask(3, 10, 40D, "gvclib:textures/entity/BulletAAA.obj",
							"gvclib:textures/entity/BulletAAA.png", "hmgww2:hmgww2.fire_amr", -1.57F, 2, 1.1, 1.0,
							this.posX, this.posY, this.posZ, 15, 15,
							30, 4F, 1F, 1F, 1, 0.020D, 400, 0, true);
				}else{
