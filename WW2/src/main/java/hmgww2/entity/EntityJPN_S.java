...
public class EntityJPN_S extends EntityJPNBase
{
    ...
    protected void dropFewItems(boolean p_70628_1_, int p_70628_2_)
    {
        ...
        if(this.worldObj.rand.nextInt(10) == 0){
        	this.dropItem(mod_GVCWW2.gun_type14, 1);
        }
    }
    ...
    protected void addRandomArmor()
    {
        ...
        if(iii == 0){
        	this.setCurrentItemOrArmor(0, new ItemStack(mod_GVCWW2.gun_type99));
        }else if(iii == 1){
        	this.setCurrentItemOrArmor(0, new ItemStack(mod_GVCWW2.gun_type99));
        }else if(iii == 2){
        	...
        	this.setCurrentItemOrArmor(0, new ItemStack(mod_GVCWW2.gun_type89));
        }else if(iii == 5){
        	this.setCurrentItemOrArmor(0, new ItemStack(mod_GVCWW2.gun_type89));
        }else
        {
    ...
    public void onUpdate()
    {
    	...
    	if (itemstack != null && itemstack.getItem() instanceof ItemGunBase) 
    	{
    		...
    		if (itemstack != null && itemstack.getItem() == mod_GVCWW2.gun_type38) 
        	{
    		...
    		if (itemstack != null && itemstack.getItem() == mod_GVCWW2.gun_type99lmg) 
        	{
    		...
    		if (itemstack != null && itemstack.getItem() == mod_GVCWW2.gun_type100) 
        	{
    		...
    		if (itemstack != null && itemstack.getItem() == mod_GVCWW2.gun_type99) 
        	{
    		...
    		if (itemstack != null && itemstack.getItem() == mod_GVCWW2.gun_type89) 
        	{
    			this.AISMove(0, 3, 0, 30, 60);
    			this.ammo1 = 40;
        		this.magazine = gun.getMaxDamage();
        		...
        		if(cooltime > ammo1 && this.getRemain_L() > 0)
    			{
    				this.Attacktask(3, 1, 40D, "gvclib:textures/entity/BulletAAA.obj",
    						"gvclib:textures/entity/BulletAAA.png", "hmgww2:hmgww2.fire_grenade", 0, 0, 1.5, 1,
    						this.posX, this.posY, this.posZ, 15, 5,
    						gun.powor/2, gun.speed, gun.bure, 2F, 1, 0.025D, 400, 0, false);
    			}
        	}
