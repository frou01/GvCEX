...
public class EntityJPN_Fighter extends EntityJPNBase
{
	// public int type;
				...
				if (this.server1) {
					if (cooltime > this.ammo1 && this.getRemain_L() > 0) {
							this.Weapon(1, player, 1.57F, 2, 1.1, 1.0,this.posX,this.posY,this.posZ,
									...
									10, 3F, 1F, 1, 1, 0.020D, false);//1.57/1.5/3
							this.Weapon(1, player, -1.57F, 2, 1.1, 1.0,this.posX,this.posY,this.posZ,
									"gvclib:textures/entity/BulletAAA.obj","gvclib:textures/entity/BulletAAA.png","hmgww2:hmgww2.fire_30mm", look,
									10, 3F, 1F, 1, 1, 0.020D, false);//1.57/1.5/3
						cooltime = 0;
					...
					if (cooltime2 > this.ammo2 && this.getRemain_R() > 0) {
						this.Weapon(0, player, 0F, 0, 1.1, 1.0,this.posX,this.posY,this.posZ,
    	...
    	{// 1
			...
			if(cooltime2 > this.ammo2 && this.getRemain_R() > 0)
			{
				this.Attacktask(0, 12, 40D, "gvclib:textures/entity/BulletAAA.obj",
						"gvclib:textures/entity/BulletAAA.png", "hmgww2:hmgww2.fire_rifle", 0, 0, 1.1, 1.0,
						this.posX, this.posY, this.posZ, 15, 15,
					     6, 4F, 1F, 1F, 1, 0.029D, 400, 0, false);
			}
		} // 1
		else{
			cooltime = 0;
