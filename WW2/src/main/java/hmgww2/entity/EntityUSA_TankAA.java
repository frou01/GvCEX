...
public class EntityUSA_TankAA extends EntityUSABase
{
	// public int type;
    ...
    public void updateRiderPosition() {
		if (this.riddenByEntity != null) {
			...
			ix -= MathHelper.sin(f1) * 1.8;
			iz += MathHelper.cos(f1) * 1.8;
			ix -= MathHelper.sin(f11) * 0.3;
			iz += MathHelper.cos(f11) * 0.3;
			...
			if (this.riddenByEntity instanceof EntityPlayer) {//player
				...
				if (this.server1) {
					if (cooltime > this.ammo1 && this.getRemain_L() > 0) {
							this.Weapon(0, player, 1.57F, 1.2D, 2.7, 2,player.posX,this.posY,player.posZ,
									"gvclib:textures/entity/BulletAAA.obj","gvclib:textures/entity/BulletAAA.png","hmgww2:hmgww2.fire_rifle", looked,
									8, 4F, 10F, 2, 1, 0.029D, false);//1.57/1.5/3
							this.Weapon(0, player, -1.57F, 1.2D, 2.7, 2,player.posX,this.posY,player.posZ,
									"gvclib:textures/entity/BulletAAA.obj","gvclib:textures/entity/BulletAAA.png","hmgww2:hmgww2.fire_rifle", looked,
									8, 4F, 10F, 2, 1, 0.029D, false);//1.57/1.5/3
							this.Weapon(0, player, 1.57F, 1.2D, 3.0, 2,player.posX,this.posY,player.posZ,
									"gvclib:textures/entity/BulletAAA.obj","gvclib:textures/entity/BulletAAA.png","hmgww2:hmgww2.fire_rifle", looked,
									8, 4F, 10F, 2, 1, 0.029D, false);//1.57/1.5/3
							this.Weapon(0, player, -1.57F, 1.2D, 3.0, 2,player.posX,this.posY,player.posZ,
									"gvclib:textures/entity/BulletAAA.obj","gvclib:textures/entity/BulletAAA.png","hmgww2:hmgww2.fire_rifle", looked,
    	...
    	{// 1
			...
			// attacktask
			{
				if(cooltime > ammo1 && this.getRemain_L() > 0)
				{
					...
					ix -= MathHelper.sin(f11) * 0.3;
					iz += MathHelper.cos(f11) * 0.3;
					this.Attacktask(0, 0, 80D, "gvclib:textures/entity/BulletAAA.obj",
							"gvclib:textures/entity/BulletAAA.png", "hmgww2:hmgww2.fire_rifle", 1.57F, 1.2D, 2.7, 2,
							this.posX - ix, this.posY, this.posZ - iz, 60, 5,
							8, 4F, 20F, 2F, 1, 0.029D, 400, 0, false);
					this.Attacktask(0, 0, 80D, "gvclib:textures/entity/BulletAAA.obj",
							"gvclib:textures/entity/BulletAAA.png", "hmgww2:hmgww2.fire_rifle", -1.57F, 1.2D, 2.7, 2,
							this.posX - ix, this.posY, this.posZ - iz, 60, 5,
							8, 4F, 20F, 2F, 1, 0.029D, 400, 0, false);
					this.Attacktask(0, 0, 80D, "gvclib:textures/entity/BulletAAA.obj",
							"gvclib:textures/entity/BulletAAA.png", "hmgww2:hmgww2.fire_rifle", 1.57F, 1.2D, 3.0, 2,
							this.posX - ix, this.posY, this.posZ - iz, 60, 5,
							8, 4F, 20F, 2F, 1, 0.029D, 400, 0, false);
					this.Attacktask(0, 1, 80D, "gvclib:textures/entity/BulletAAA.obj",
							"gvclib:textures/entity/BulletAAA.png", "hmgww2:hmgww2.fire_rifle", -1.57F, 1.2D, 3.0, 2,
							this.posX - ix, this.posY, this.posZ - iz, 60, 5,
							8, 4F, 20F, 2F, 1, 0.029D, 400, 0, false);
				}
