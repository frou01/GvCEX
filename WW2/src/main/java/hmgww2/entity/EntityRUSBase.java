...
public class EntityRUSBase extends EntityBases {

	public float roo;
	public int deathTicks;
	public int type = 0;

	public EntityRUSBase(World par1World) {
		super(par1World);
		this.flagbase = new BlockRUSFlagBase();
	...
	public boolean CanAttack(Entity entity) {
		if (!(entity instanceof EntityRUSBase) && entity instanceof EntityGolem && !entity.isDead  && ((EntityLivingBase) entity).getHealth() > 0.0F) {
			return true;
