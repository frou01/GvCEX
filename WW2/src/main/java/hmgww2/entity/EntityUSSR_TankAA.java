...
public class EntityUSSR_TankAA extends EntityUSSR_TankBase
{
    ...
    public EntityUSSR_TankAA(World par1World)
    {
        ...
        baseLogic = new TankBaseLogic(this,0.14f,1.8f,false,"gvcmob:gvcmob.T34Track");
        ...
        mainTurret = new TurretObj(worldObj);
        {
            ...
            mainTurret.turretPitchCenterpos = new Vector3d(0F, 2.65F, -0.8f);
            mainTurret.turretPitchCenterpos.sub(turretpos);
