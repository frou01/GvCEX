...
public class EntityGER_FighterA extends EntityGERBase
{
	// public int type;
    	...
    	{// 1
			...
			if(cooltime > ammo1 && this.getRemain_L() > 0)
			{
				this.Attacktask(0, 15, 40D, "gvclib:textures/entity/BulletAAA.obj",
						"gvclib:textures/entity/BulletAAA.png", "hmgww2:hmgww2.fire_rifle", 1.57F, 2, 1.1, 1.0,
						this.posX, this.posY, this.posZ, 15, 15,
					     8, 3F, 1F, 1F, 1, 0.020D, 400, 0, false);
				this.Attacktask(0, 10, 40D, "gvclib:textures/entity/BulletAAA.obj",
						"gvclib:textures/entity/BulletAAA.png", "hmgww2:hmgww2.fire_rifle", -1.57F, 2, 1.1, 1.0,
						this.posX, this.posY, this.posZ, 15, 15,
					     8, 3F, 1F, 1F, 1, 0.020D, 400, 0, false);
			}
