...
public class EntityJPN_TankAA extends EntityJPNBase
{
    ...
    public void updateRiderPosition() {
		if (this.riddenByEntity != null) {
			...
			double iy = 0;
			double iz = 0;
			float f1 = ((EntityLivingBase) this.riddenByEntity).rotationYawHead * (2 * (float) Math.PI / 360);
	...
	public boolean attackEntityFrom(DamageSource source, float par2)
    {
		...
		if(entity != null){
			...
			{
				par2 = par2 * this.TankArmor(entity,par2, 1F, 1.6F, 1.8F, this.rotation) * this.AntiBullet(entity, par2, 0);
    ...
    public void onUpdate()
    {
			...
			if (this.riddenByEntity instanceof EntityPlayer) {//player
				...
				if (this.server1) {
					if (cooltime > this.ammo1 && this.getRemain_L() > 0) {
							this.Weapon(1, player, 1.57F, 0.25D, 2.8, 2,this.posX,this.posY,this.posZ,
									"gvclib:textures/entity/BulletAAA.obj","gvclib:textures/entity/BulletAAA.png","hmgww2:hmgww2.fire_30mm", looked,
									10, 4F, 10F, 2, 1, 0.029D, false);//1.57/1.5/3
							this.Weapon(1, player, -1.57F, 0.25D, 2.8, 2,this.posX,this.posY,this.posZ,
									"gvclib:textures/entity/BulletAAA.obj","gvclib:textures/entity/BulletAAA.png","hmgww2:hmgww2.fire_30mm", looked,
									10, 4F, 10F, 2, 1, 0.029D, false);//1.57/1.5/3
						cooltime = 0;
    	...
    	{// 1
			...
			// attacktask
			{
				...
				{
					this.Attacktask(1, 0, 80D, "gvclib:textures/entity/BulletAAA.obj",
							"gvclib:textures/entity/BulletAAA.png", "hmgww2:hmgww2.fire_30mm", 1.57F, 0.25D, 2.8, 2,
							this.posX, this.posY, this.posZ, 60, -2,
							10, 6F, 20F, 2F, 1, 0.029D, 400, 0, false);
