...
//		this.tasks.addTask(8, new EntityAILookIdle(this));
	...
	public void onUpdate() {
		...
		if (this.getAttackTarget() != null && (getAttackTarget() instanceof EntityBases_Plane && ignoreTargetAir) || this.is_this_entity_friend(this.getAttackTarget()))
...
//			double angle_position = abs(toDegrees(TankFrontVec.angle(shooterPositionVec)));
	...
	public boolean attackEntityFrom(DamageSource source, float par2) {
		if (source.getDamageType().equals(DamageSource.fall.damageType) ||
				...
				source.getDamageType().equals(DamageSource.inWall.damageType))
			return attackEntityFrom_exceptArmor(source, par2);
		par2 -= armor;
		if (par2 < 0) par2 = 0;
	...
	public boolean is_this_entity_friend(Entity entity) {
		if (entity instanceof EntityBases) {
			...
			if ((((LMM_EntityLittleMaid) entity).getMaidMasterEntity()).getEquipmentInSlot(4) != null && (((LMM_EntityLittleMaid) entity).getMaidMasterEntity()).getEquipmentInSlot(4).getItem() != null)
				return this.getnation() == ((ItemIFFArmor) (((LMM_EntityLittleMaid) entity).getMaidMasterEntity()).getEquipmentInSlot(4).getItem()).nation;
		}
		return false;
	}
