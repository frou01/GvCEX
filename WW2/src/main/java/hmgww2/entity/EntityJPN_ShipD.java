...
public class EntityJPN_ShipD extends EntityJPNBase
{
	// public int type;
    ...
    public void onUpdate()
    {
				...
				if (this.server1) {
					if (cooltime > this.ammo1) {
						Vec3 looked = player.getLookVec();
						{
							...
							double xx13 = 0;
							double zz13 = 0;
							xx13 -= MathHelper.sin(this.rotationYaw * 0.01745329252F) * 5.5;
							zz13 += MathHelper.cos(this.rotationYaw * 0.01745329252F) * 5.5;
							xx13 -= MathHelper.sin(this.rotation * 0.01745329252F) * 1.5;
							zz13 += MathHelper.cos(this.rotation * 0.01745329252F) * 1.5;
							
							{
								EntityB_BulletAA var3 = new EntityB_BulletAA(player.worldObj, this, this);
								var3.Bdamege = 25;
								var3.gra = 0.029;
								var3.friend = this;
								var3.exnear = true;
								...
								var3.setThrowableHeading(looked.xCoord, looked.yCoord+0.1, looked.zCoord, 1.6F, 5F);
							...
							}
							{
								...
								var3.friend = this;
								var3.exnear = true;
								var3.setLocationAndAngles(player.posX + xx13, this.posY + 6D, player.posZ + zz13,
										player.rotationYaw, player.rotationPitch);
								var3.setThrowableHeading(looked.xCoord, looked.yCoord+0.1, looked.zCoord, 1.6F, 5F);
								if (!player.worldObj.isRemote) {
									player.worldObj.spawnEntityInWorld(var3);
				...
				if (this.server2) {
					if (cooltime2 > this.ammo2) {
						Vec3 looked = player.getLookVec();
						{
							...
							{
								EntityT_Torpedo var3 = new EntityT_Torpedo(player.worldObj, this);
								var3.Bdamege = 400;
								var3.friend = this;
								var3.extime = 1200;
    	...
    	{// 1
			...
			List<Entity> llist = this.worldObj.getEntitiesWithinAABBExcludingEntity(this,
					this.boundingBox.addCoord(this.motionX, this.motionY, this.motionZ).expand(100D, 80D, 100D));
			if (llist != null) {
					...
					//if (flag) 
					{
						Vec3 looked = this.getLookVec();
						{
							...
							
							{
								...
								var3.setThrowableHeading(var4, var6 + (double) var10, var8, 1.6F, 25.0F);
								if (!this.worldObj.isRemote) {
							...
							}
							{
								...
								var3.friend = this;
								var3.exnear = true;
								var3.setLocationAndAngles(this.posX + xx13, this.posY + 6D, this.posZ + zz13,
										this.rotationYaw, this.rotationPitch);
								double var4 = entity1.posX - this.posX;
								double var6 = entity1.posY + (double) entity1.getEyeHeight()
										+ 0.200000023841858D - var3.posY;
