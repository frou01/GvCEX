...
public class RenderJPN_FighterA extends Render {

	private static final ResourceLocation skeletonTexturesz = new ResourceLocation("hmgww2:textures/mob/jpn/B7A.png");
	private static final IModelCustom tankk = AdvancedModelLoader.loadModel(new ResourceLocation("hmgww2:textures/mob/jpn/B7A.obj"));
	private float scale;

	public RenderJPN_FighterA() {
		this.scale = 2;
	}

	public void doRender(Entity p_76986_1_, double p_76986_2_, double p_76986_4_, double p_76986_6_, float p_76986_8_,
			float p_76986_9_) {
		this.doRender((EntityJPN_FighterA) p_76986_1_, p_76986_2_, p_76986_4_, p_76986_6_, p_76986_8_, p_76986_9_);
	}
	
	float xsxs;
	public void doRender(EntityJPN_FighterA entity, double p_76986_2_, double p_76986_4_, double p_76986_6_,
	...
	private void renderAngle(EntityJPN_FighterA p_76986_1_, int i){
		{
