...
public class RenderJPN_ShipB extends Render {

	private static final ResourceLocation skeletonTexturesz = new ResourceLocation("hmgww2:textures/mob/jpn/BattleShip.png");
	private static final IModelCustom tankk = AdvancedModelLoader.loadModel(new ResourceLocation("hmgww2:textures/mob/jpn/BattleShip.obj"));
	private float scale;

	public RenderJPN_ShipB() {
		this.scale = 2;
	}

	public void doRender(Entity p_76986_1_, double p_76986_2_, double p_76986_4_, double p_76986_6_, float p_76986_8_,
			float p_76986_9_) {
		this.doRender((EntityJPN_ShipB) p_76986_1_, p_76986_2_, p_76986_4_, p_76986_6_, p_76986_8_, p_76986_9_);
	}
	float xsxs;
	public void doRender(EntityJPN_ShipB entity, double p_76986_2_, double p_76986_4_, double p_76986_6_,
	...
	private void renderAngle(EntityJPN_ShipB p_76986_1_, int i){
		{
