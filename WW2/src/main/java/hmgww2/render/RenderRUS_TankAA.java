...
public class RenderRUS_TankAA extends Render {
	...
	private static final ResourceLocation skeletonTexturesz = new ResourceLocation("hmgww2:textures/mob/rus/ZIS43.png");
	private static final IModelCustom tankk = AdvancedModelLoader.loadModel(new ResourceLocation("hmgww2:textures/mob/rus/ZIS43.obj"));
	private float scale;

	public RenderRUS_TankAA() {
		this.scale = 2;
	}
	...
	*/
	...
	public void doRender(EntityRUS_TankAA entity, double p_76986_2_, double p_76986_4_, double p_76986_6_,
		...
		
		{
			...
			GL11.glTranslatef(0F, 2.65F, -0.8F);
