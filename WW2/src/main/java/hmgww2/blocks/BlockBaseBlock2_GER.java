...
public class BlockBaseBlock2_GER extends Block
{
    ...
    public void onBlockAdded(World par1World, int par1, int par2, int par3)
    {
    	for (int l = 1; l < 64; l++) {
        	...
        	par1World.setBlock(par1+15, par2+1, par3+15, mod_GVCWW2.b_flag2_ger);
    }
    ...
    public void BuildTent(World par1World, int par1, int par2, int par3){
    	...
    	for (int i0 = 0; i0 < 9; ++i0){
    			for (int i2 = 0; i2 < 13; ++i2){
    				{
    					par1World.setBlock(par1+i0, par2+5, par3+i2, Blocks.wool,9,2);
    				}
    			}
    	}
