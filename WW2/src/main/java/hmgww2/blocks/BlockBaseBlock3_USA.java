...
public class BlockBaseBlock3_USA extends Block
{
    ...
    public void onBlockAdded(World par1World, int par1, int par2, int par3)
    {
    	for (int l = 1; l < 64; l++) {
        	...
        	par1World.setBlock(par1+30, par2+1, par3+17, mod_GVCWW2.b_flag3_usa);
    }
    ...
    public void BuildTower(World par1World, int par1, int par2, int par3){
    	...
    	par1World.setBlock(par1+3, par2+8, par3+1, Blocks.wool,11,2);
