...
public class BlockBaseBlock_USA extends Block
{
    ...
    public void onBlockAdded(World par1World, int par1, int par2, int par3)
    {
    	for (int l = 1; l < 64; l++) {
        	...
        	par1World.setBlock(par1+7, par2+1, par3+7, mod_GVCWW2.b_flag_usa);
    }
    public void BuildChest(World par1World, int par1, int par2, int par3){
    	{
	    	...
	    	{
	    		for (int i = 0; i < 9; ++i){
		            Chest.setInventorySlotContents(i, new ItemStack(mod_GVCWW2.armor_usa,1,0));
		        }
	    		...
	    		Chest.setInventorySlotContents(14, new ItemStack(mod_GVCWW2.gun_m1904,1,0));
	    		Chest.setInventorySlotContents(15, new ItemStack(mod_GVCWW2.gun_m1904,1,0));
    	...
    	for (int i0 = 0; i0 < 5; ++i0){
    		for (int i1 = 0; i1 < 3; ++i1){
    			for (int i2 = 0; i2 < 3; ++i2){
    				{
    					par1World.setBlock(par1+i0, par2+i1, par3+i2, Blocks.wool,13,2);
    				}
    			}
    		}
