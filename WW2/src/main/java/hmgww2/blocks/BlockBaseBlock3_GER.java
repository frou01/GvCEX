...
public class BlockBaseBlock3_GER extends Block {
	...
	public void onBlockAdded(World par1World, int par1, int par2, int par3) {
		...
		par1World.setBlock(par1 + 30, par2 + 1, par3 + 17, mod_GVCWW2.b_flag3_ger);
	}
	...
	public void BuildTent(World par1World, int par1, int par2, int par3) {
		...
		for (int i0 = 0; i0 < 16; ++i0) {
			for (int i2 = 0; i2 < 10; ++i2) {
				{
					par1World.setBlock(par1 + i0, par2 + 6, par3 + i2, Blocks.wool, 9, 2);
				}
			}
		}
	...
	public void BuildTower(World par1World, int par1, int par2, int par3) {
		...
		par1World.setBlock(par1 + 3, par2 + 8, par3 + 1, Blocks.wool, 9, 2);
		par1World.setBlock(par1 + 4, par2 + 8, par3 + 1, Blocks.wool, 9, 2);
