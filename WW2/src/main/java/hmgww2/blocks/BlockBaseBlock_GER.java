    ...
    public void BuildChest(World par1World, int par1, int par2, int par3){
    	{
	    	...
	    	Chest = (TileEntityChest) par1World.getTileEntity(par1, par2, par3);
	    	{
	    		...
	    		Chest.setInventorySlotContents(9, new ItemStack(mod_GVCWW2.gun_kar98,1,0));
	    		Chest.setInventorySlotContents(10, new ItemStack(mod_GVCWW2.gun_kar98,1,0));
	    		Chest.setInventorySlotContents(11, new ItemStack(mod_GVCWW2.gun_kar98,1,0));
	    		...
	    		Chest.setInventorySlotContents(14, new ItemStack(mod_GVCWW2.gun_kar98sr,1,0));
	    		Chest.setInventorySlotContents(15, new ItemStack(mod_GVCWW2.gun_kar98sr,1,0));
	    		Chest.setInventorySlotContents(16, new ItemStack(mod_GVCWW2.gun_fg42,1,0));
