...
public class BlockFlag2_GER extends BlockGERFlagBase
{
    ...
    public boolean onBlockActivated(World par1World, int par1, int par2, int par3, EntityPlayer p_149727_5_, int p_149727_6_, float p_149727_7_, float p_149727_8_, float p_149727_9_)
    {
        ...
        {
        	TileEntityFlag2_GER flag = (TileEntityFlag2_GER) par1World.getTileEntity(par1, par2, par3);
        	if(flag.spawn){
        		flag.spawn = false;
        	}else{
        		flag.spawn = true;
	...
	public TileEntity createNewTileEntity(World world, int a) {
		...
		return new TileEntityFlag2_GER();
	}
}