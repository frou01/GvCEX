...
public class RenderFallingBlockMod extends Render
{
     ...
     */
    public void doRender(HMGEntityFallingBlockModified p_76986_1_, double p_76986_2_, double p_76986_4_, double p_76986_6_, float p_76986_8_, float p_76986_9_)
    {
        ...
        if (block != null && block != world.getBlock(i, j, k))
        {
            ...
            if (block instanceof BlockAnvil)
            {
                ...
                this.field_147920_a.renderBlockAnvilMetadata((BlockAnvil)block, i, j, k, p_76986_1_.Data);
            ...
            else
            {
                ...
                this.field_147920_a.renderBlockAsItem(block, p_76986_1_.Data,p_76986_1_.getBrightness(p_76986_9_));
            }
     ...
     */
    protected ResourceLocation getEntityTexture(HMGEntityFallingBlockModified p_110775_1_)
    {
    ...
    {
        return this.getEntityTexture((HMGEntityFallingBlockModified)p_110775_1_);
    }
    ...
    {
        this.doRender((HMGEntityFallingBlockModified)p_76986_1_, p_76986_2_, p_76986_4_, p_76986_6_, p_76986_8_, p_76986_9_);
    }
}