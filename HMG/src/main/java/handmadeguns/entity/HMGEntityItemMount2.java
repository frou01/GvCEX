...
public class HMGEntityItemMount2 extends HMGEntityItemMountBase 
{
    ...
    public HMGEntityItemMount2(World p_i1692_1_)
    {
        super(p_i1692_1_);
        this.setSize(1F, 1F);
    }
    ...
    {
        this.dropItem(HandmadeGunsCore.hmg_handing2, 1);
    }
	/**
	...
	public boolean interact(EntityPlayer p_130002_1_)
    {
        ...
        {
		p_130002_1_.openGui(HandmadeGunsCore.INSTANCE, 2, p_130002_1_.worldObj, (int)p_130002_1_.posX, (int)p_130002_1_.posY, (int)p_130002_1_.posZ);
        }
		}else{
			if(this.getMuki() < 3){
