package handmadeguns.inventory;
...
public class ContainerHolder extends Container
{
    ...
    public ContainerHolder(IInventory p_i1806_1_, IInventory p_i1806_2_)
    {
        this.lowerChestInventory = p_i1806_2_;
        this.numRows = p_i1806_2_.getSizeInventory() / 9;
        this.numlastRoaws = p_i1806_2_.getSizeInventory() % 9;
        ...
        for (k = 0; k < numlastRoaws; ++k)
        {
            this.addSlotToContainer(new Slot(p_i1806_2_, k + j * 9, 8 + k * 18, 18 + j * 18));
        }

        if(numlastRoaws != 0)numRows++;
