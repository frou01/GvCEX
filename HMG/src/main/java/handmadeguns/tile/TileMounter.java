...
public class TileMounter extends TileEntityChest {
    ...
    public TileMounter(int p_i2350_1_)
    {
    ...
    {
        if(p_70301_1_ < chestContents.length)
    ...
    {
        return this.hasCustomInventoryName() ? this.customName : "Item Mount";
    }
...
//            f = 10.0F;
//            List listplayers = this.worldObj.getEntitiesWithinAABB(EntityPlayer.class, AxisAlignedBB.getBoundingBox((double) ((float) this.xCoord - f), (double) ((float) this.yCoord - f), (double) ((float) this.zCoord - f), (double) ((float) (this.xCoord + 1) + f), (double) ((float) (this.yCoord + 1) + f), (double) ((float) (this.zCoord + 1) + f)));
//            for (Object tgt : listplayers) {
//                if (tgt instanceof EntityPlayerMP) {
//                    ((EntityPlayerMP) tgt).playerNetServerHandler.sendPacket(getDescriptionPacket());
//                }
//            }
//        }
