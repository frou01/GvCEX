...
public class EntityItemFrameHMG extends EntityItemFrame
{
    /** Chance for this item frame's item to drop from the frame. */
    private float itemDropChance = 1.0F;
    private static final String __OBFID = "CL_00001547";

    public EntityItemFrameHMG(World p_i1590_1_)
    {
        super(p_i1590_1_);
    }

    public EntityItemFrameHMG(World p_i1591_1_, int p_i1591_2_, int p_i1591_3_, int p_i1591_4_, int p_i1591_5_)
    {
    ...
    private void removeFrameFromMap(ItemStack p_110131_1_)
    {
        if (p_110131_1_ != null)
        {
            ...
            p_110131_1_.setItemFrame((EntityItemFrameHMG)null);
        }
    }
