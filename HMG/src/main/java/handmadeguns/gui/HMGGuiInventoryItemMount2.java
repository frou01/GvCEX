...
public class HMGGuiInventoryItemMount2 extends GuiContainer
{
    //private static final ResourceLocation texture = new ResourceLocation("textures/gui/container/generic_54.png");
    private static final ResourceLocation texture = new ResourceLocation("handmadeguns:textures/gui/AR.png");
 
    public HMGGuiInventoryItemMount2(IInventory inventoryPlayer, ItemStack itemstack, HMGEntityItemMount2 en)
    {
    	super(new HMGContainerInventoryItemMount2(inventoryPlayer, itemstack, en));
        this.ySize = 222;
    }
